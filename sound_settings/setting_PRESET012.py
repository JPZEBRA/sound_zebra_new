...
from sound_base.FM.sound_FM_pre import FM_pre_sound_square
...
from sound_base.FM.sound_FM_pre import FM_pre_rghorn
...
def set_sound(note,sound_a,sampling,duration) :
    ...
    sa  = FM_pre_sound_square(note,sound_a,sampling,duration)

    set_FME_very_hard()

    ea = set_Envelope(duration,1.0)

    sb = Modulate(sa,ea,0.4,0.0)
