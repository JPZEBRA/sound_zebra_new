...
from sound_base.FM.sound_FM_envelope import set_FME_grow
...
from sound_base.FM.sound_FM_unit import CNoiseNote
...
def set_sound(note,sound_a,sampling,duration) :
    ...
    sa0  = FM_pre_sound(note,sound_a,sampling,duration)

    set_FME_slow()

    sa1 = set_FME(sa0,duration)

    sc0 = SINNote(sound_a,duration,note,0.03,0.00,sampling)

    set_FME_grow()

    sce = set_Envelope(duration,1.00)

    sc1 = sce * sc0

    sa2 = Modulate(sa1,sc1,0.10,0.00)
